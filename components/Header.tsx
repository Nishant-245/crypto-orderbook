...
export default function Header({ selectedPair, onPairChange }) {
  return (
    <header className="text-center space-y-4">
      <h1 className="text-5xl font-bold text-green-500">Blockchain Exchange</h1>
      ...
      <Select onValueChange={onPairChange} defaultValue={selectedPair.symbol}>
        <SelectTrigger className="w-[180px] bg-gray-800 text-gray-400 border-green-500 mx-auto">
